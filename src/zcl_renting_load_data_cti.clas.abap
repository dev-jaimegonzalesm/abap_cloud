CLASS zcl_renting_load_data_cti DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_cti IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

  DATA: lt_brands    TYPE TABLE OF zrent_brands_cti,
        lt_cars      TYPE TABLE OF zrent_cars_cti,
        lt_customers TYPE TABLE OF zrent_custom_cti.
...
DELETE FROM zrent_brands_cti.
INSERT zrent_brands_cti FROM TABLE @lt_brands.
SELECT * FROM zrent_brands_cti INTO TABLE @lt_brands.
out->write( sy-dbcnt ).
...
DELETE FROM zrent_cars_cti.
INSERT zrent_cars_cti FROM TABLE @lt_cars.
SELECT * FROM zrent_cars_cti INTO TABLE @lt_cars.
out->write( sy-dbcnt ).
...
DELETE FROM zrent_custom_cti.
INSERT zrent_custom_cti FROM TABLE @lt_customers.
SELECT * FROM zrent_custom_cti INTO TABLE @lt_customers.
out->write( sy-dbcnt ).
